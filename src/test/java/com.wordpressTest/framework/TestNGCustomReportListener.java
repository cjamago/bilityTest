...
public class TestNGCustomReportListener implements IReporter {
        ...
        if (tests.getAllResults().size() > 0) {
            ...
            for (ITestNGMethod method : getMethodSet(tests, suite)) {
                ...
                +"</a>"
                        ...
                        + "<td class='numi + style='text - align:left;padding - right:2e m>" + firstLine + "<br/></td>"
    ...
    private void startSummaryRow(String label) {
        ...
        + "><td style= text - align:left;padding - right:2e m ><a href=#t "
    ...
    private void tableStart(String cssclass, String id) {
        writer.println("<table cellspacing='0' cellpadding='0'"
                + (cssclass != null ? " class=" + cssclass + "":" style= padding - bottom:2e m ")
        +(id != null ? " id=" + id + "" :"") + ">");
        m_row = 0;
    }
